...
<body style="background-color:#ffe187; color:rgb(128, 37, 5)">
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <p></p>
            <p>
            <a style="color:rgb(128, 37, 5); text-decoration:none;" href="{{route('notas.show',$a->id)}}"><b >Pedido mesa:</b> {{$a->mesa}}
            @if($a->situation == '0')
                <b style="color: green"> Preparação</b>
            
            @else
               <b style="color: red">Pronto</b>
